...
void Userinterface::rectangle()
{
	m_rectangle.setSize(sf::Vector2f(750, 75));
	m_rectangle.setFillColor(sf::Color(128, 128, 128));
	m_rectangle.setPosition(50, 700);
}

void Userinterface::text(sf::Font &font)
{

	m_text.setFont(font);
	m_text.setString("Send");
	m_text.setCharacterSize(20);
	m_text.setFillColor(sf::Color::White);
	m_text.setPosition(880, 725);
}

void Userinterface::setupUI(sf::Font &font)
{
	rectangle();
	text(font);
}
